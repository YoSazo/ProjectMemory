...
def _build_parser() -> argparse.ArgumentParser:
    ...
    agency_quantity.add_argument(
        ...
        choices=[
            ...
            "nvidia_constraint_family_only",
            "nvidia_semantic_compiled",
            "nvidia_semantic_no_below_increment",
            "nvidia_semantic_no_above_decrement",
            "nvidia_semantic_swap_increment_decrement",
            "nvidia_semantic_no_verifier",
            "minimal_label_numeric_quantity",
            "minimal_label_numeric_price",
            "minimal_label_text_identity",
            "minimal_label_random",
        ],
        default=[],
